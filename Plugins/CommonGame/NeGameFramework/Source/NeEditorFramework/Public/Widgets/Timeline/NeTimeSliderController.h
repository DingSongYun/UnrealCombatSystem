 ...
 */
class NEEDITORFRAMEWORK_API FNeTimeSliderController : public ITimeSliderController
{
public:
	FNeTimeSliderController( const FTimeSliderArgs& InArgs, TWeakPtr<FNeTimelineMode> InTimelineMode, TWeakPtr<SNeTimeline> InWeakTimeline, TSharedPtr<INumericTypeInterface<double>> InSecondaryNumericTypeInterface );
...
private:
	...
	TWeakPtr<SNeTimeline> WeakTimeline;
